...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DjtGzNLo.js");
...
const manifest = {
  "577fd75b88080caeb9ffe7939e431024f7655abc0df50436c00c801cb0b140ee": {
    functionName: "runMatching_createServerFn_handler",
    importer: () => import("./matching.functions-BD40qfYk.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-qGr_Hydj.js").then((n2) => n2.j),
    import("./start-C9zh7V2L.js"),
